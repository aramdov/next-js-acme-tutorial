'use client';
import { useFormState } from 'react-dom'; // import the hook from react-dom
      ...
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div id="customer-error" aria-live="polite" aria-atomic="true">
            {/* ternary operator that checks for each specific error.*/ }
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                // required. This would be client side validation.
